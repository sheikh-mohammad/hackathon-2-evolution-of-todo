...
This guide provides step-by-step instructions to get started with the Phase I Console Todo App, including installation, setup, and basic usage.
...
```bash
python -m src.todo_app.cli.todo_cli --help
```